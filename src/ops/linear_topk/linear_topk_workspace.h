...
inline constexpr std::int32_t kLinearTopKWidth              = 7;
inline constexpr std::int32_t kLinearTopKMaxBatch           = 8;
inline constexpr std::int32_t kLinearTopKMRowsPerGroup      = 128;
inline constexpr std::int32_t kLinearTopKKSplitRowsPerGroup = 16;
...
LinearTopKWorkspace allocate_linear_topk_workspace(Allocator& allocator, std::int32_t head_rows,
                                                   std::int32_t columns,
                                                   std::int32_t rows_per_producer) {
