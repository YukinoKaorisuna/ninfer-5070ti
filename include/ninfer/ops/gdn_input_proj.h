...
/**
 * Returns transient snapshot capacity for the split Q4/Q5 GDN profile using the
 * actual value/z weight format. Q5 preserves the fused small-T schedule; Q4
 * uses the format-generic materialized projection path.
 */
[[nodiscard]] std::size_t gdn_input_proj_conv_snapshot_workspace_capacity_bytes(
